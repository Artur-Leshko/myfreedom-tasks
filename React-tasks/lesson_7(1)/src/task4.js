...
function connect(Component) {
  class WithConnect extends React.Component {
    static displayName = `withConnect(${Component.displayName || Component.name || ''})`;
...
class AppWithGlobalState extends React.Component {
  ...
  render() {
    return (
      ...
      <>
        <StateContext.Provider value={{state: this.state, setState: (nextState) => this.setState(nextState)}}>
          <Container>
            <Row>
              <Col>
                <ConnectedInput />
